...
| 3 | `sho5ge` | 正五位下 | 40 | 800 | +120 | 解鎖停戰斡旋 |
| 4 | `ju4ge` | 從四位下 | 50 | 1,200 | +170 | 政策槽 +1 |
| 5 | `ju4jo` | 從四位上 | 60 | 1,800 | +230 | 從屬勸告接受度 +10 |
| 6 | `sho4ge` | 正四位下 | 70 | 2,500 | +300 | 斡旋友好度成本 ×0.75 |
| 7 | `ju3` | 從三位 | 85 | 3,500 | +400 | 同盟/不可侵接受度 +5 |
| 8 | `sho1` | 正一位 | 95 | 5,000 | +550 | 政策槽再 +1（累計 +2） |
...
|---|---|---|---|---|---|---|---|
| 1 | `otomoshu` | 御供眾 | 150 | 30 | 500 | +60 | 幕府事件額外選項 |
| 2 | `oshobanshu` | 御相伴眾 | 350 | 50 | 1,000 | +120 | 外交/獻金工作月費 ×0.8 |
| 3 | `kanreidai` | 管領代 | 600 | 70 | 2,000 | +200 | 從屬勸告接受度 +15 |
